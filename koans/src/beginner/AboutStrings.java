...
public class AboutStrings {
	...
	public void newString() {
		...
		/*
			...
			если мы не используем конструктора явно, как сдесь:
			    String empty = "";
	...
	public void newStringIsRedundant() {
        ...
        /*
            сдесь просто еще раз показивается что эффект один и тот же (в контексте значения живущего в обьекте на выходе)
         */
	}
	...
	public void readableStringFormattingWithMessageFormat() {
        ...
        /*
            сдесь мы видим альтернативу использованию % для обозначения мест куда нужно подставить аргументы начиная
            с второго.
