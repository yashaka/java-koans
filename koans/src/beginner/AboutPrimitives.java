...
public class AboutPrimitives {
	...
	public void integerSize() {
        ...
        /*
            ...
            Все данные кодируются в виде наборов нулей и единиц, и хранятся в соответствующего размера ячейках.
            Целые числа хранятся в ячейках из 4 байт - 4х8 бит = 32
            Именно финальное количество битов, используемых для кодировки, - и влияет на максимально допустимое число.
