...
public class AboutEquality {
	...
	public void equalsMethodCanBeChangedBySubclassesToTestsIfTwoObjectsAreEqual(){
        ...
        /*
           ...
           Как видите ми все еще используем абслютно разные ящики в каждом случае. То есть мы не спользовали здесь
           sub-typing полиморфизм.

           Но зато... мы здесь использовали другой тим полиморфизма - "ad hoc" полиморфизм. В джаве он реализауется
