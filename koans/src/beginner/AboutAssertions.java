	...
	public void assertSameInstance(){
        ...
        /*
            ***
            ...
            Так вот, есть способ указать джаве: несмотря на то, что объект, который мы кладем в ящик, -  есть обьектом класса Integer,
            ...
            *** assertSame(same, sameRefence) ***
            ...
            то есть в нашем случае использования - Указывают ли ссылки живущие в ящиках - same и sameReference -
            на один и тот же обьект в памяти.
         */
	}
